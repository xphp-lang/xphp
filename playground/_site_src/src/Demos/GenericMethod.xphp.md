---
title: "src/Demos/GenericMethod.xphp"
layout: default
---

[← index](../../index.md) · [Source `.xphp` files](../../index.md#source)

# `src/Demos/GenericMethod.xphp`
