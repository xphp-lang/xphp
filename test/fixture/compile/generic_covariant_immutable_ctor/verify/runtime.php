...
/**
 * Runtime verify for `generic_covariant_immutable_ctor`:
...
use App\CovariantCtor\Banana;
use App\CovariantCtor\Fruit;
...
$bananaListFqn = Registry::generatedFqn(
    'App\\CovariantCtor\\ImmutableList',
    [new TypeRef('App\\CovariantCtor\\Banana')],
);
$threw = false;
try {
