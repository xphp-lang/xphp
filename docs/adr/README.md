...
| [0016](0016-namespaced-hashable-bound.md) | A namespaced `XPHP\Hashable` value-equality bound | Superseded by 0017 |
| [0017](0017-no-special-cased-value-equality-bound.md) | No special-cased value-equality bound (use ordinary generics) | Accepted |
