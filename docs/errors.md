...
| `xphp.alias_unsupported_body` | a type-alias body that is not a single head, a union, an intersection, a nullable, or a DNF — today this is a closure signature (`Closure(int): int`) |
